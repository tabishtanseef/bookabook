			...
			<div id="right_content">
			  ...
			  <div id="products_box">
				...
				
				{
					...
					<br>
					<h3 align='center'>SELLER INFORMATION</h3><br>
					
					<p align='right'><b style='color:black; font-size:20px;'>Name : $s_name </b></p><br>
					<p align='right'><b style='color:black; font-size:20px;'> Contact No. : $s_no </b></p><br>
					<p align='right'><b style='color:black; font-size:20px;'>City : $s_city</b></p><br>
					<a href=details.php?book_id=$book_id; style='float:left; color:red; font-size:20px; text-decoration:none;'>Go Back</a>
